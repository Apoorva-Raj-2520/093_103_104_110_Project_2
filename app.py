...
def main():
    ...
    if choice == "Login":
        ...
        if st.session_state.show_login == False:
            ...
            if st.button("Add Task", key="add_task_btn",  help="Click to add task"):
        ...
        if st.session_state.show_login == False:
            ...
            if "payload" in result:
                ...
                if selected_result:
                    ...
                    if st.button("Update Task", key="update_task_btn", help="Click to update task"):
        ...
        if st.session_state.show_login == False:
            ...
            if "payload" in result:
                ...
                if st.button("Delete Task", key="delete_task_btn", help="Click to delete task"):
