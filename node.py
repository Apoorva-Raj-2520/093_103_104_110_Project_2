...
class Node():
    ...
    def __init__(self, fellow, my_ip):
        ...
        self.mydb = mysql.connector.connect(host="localhost", user="root", password="1234", database="task")
        self.log = []
        self.staged = None
        self.term = 0
    ...
    #     # Print information about the node's state directly
    #     print(f"Node Address: {self.addr}")
    #     print(f"Term: {self.term}")
    #     print(f"Status: {self.status}")

    def print_all_instances():
        print("List of all Node instances:")
        for instance in Node.instances:
            print(f"Address: {instance.addr}")

    def get_node_info(self):
        # Method to print information about the current node instance
        print(f"Node Address: {self.addr}")
